...
// 属性ワード (レジスタ +4、および BG ネームテーブル) のビット割り当て。
//
//   bit 0-7   : PCG のパターン番号
//   bit 8-11  : パレットブロック
//   bit 14    : 水平反転
//   bit 15    : 垂直反転
//
// Why not bit8/bit9 を反転に使わないか: そこはパレットブロックの領分で、
// 実機 (MAME の x68k_v.cpp は反転を $4000/$8000、パレットを $0F00 で読む) では
// 反転のつもりの bit8 がパレット番号 1 として解釈され、色が変わってしまう。
#define SPR_ATTR_HFLIP 0x4000u
#define SPR_ATTR_VFLIP 0x8000u
